...
bool Table::initialize()
{
    ...
    boost::filesystem::path suits_table_path =
        get_data_path("suits_table_nyanten.bin");
    boost::filesystem::path honors_table_path =
        get_data_path("honors_table_nyanten.bin");
#else
    boost::filesystem::path suits_table_path = get_data_path("suits_table.bin");
    boost::filesystem::path honors_table_path = get_data_path("honors_table.bin");
#endif
